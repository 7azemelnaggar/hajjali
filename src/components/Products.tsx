...
import { categories, getProductsForCategory } from './productData';
          ...
          {categories.map((cat, index) => {
            return (
              ...
              >
                ...
                >
                  <div className="relative h-72 sm:h-80 rounded-3xl overflow-hidden border border-cream-200 shadow-sm hover:shadow-2xl transition-all duration-500">
                    {/* Image */}
                    <img
                      src={cat.image}
